...
%DomainFile = "1km_data/domain.lnd.r05_gx1v6.191014.nc";
...
function fname_out = CreateELMUgridSurfdat(lati_region, long_region, ...
...
%disp('warning: close pftmask check when running globally')
